...
import { DependencyContainer} from "bulbulakabulbul";
...
export class TraderHelper
{
    ...
    public createP90Rogue(): Item[] // p90
    {
        const P90Rogue = [];
        P90Rogue.push({
